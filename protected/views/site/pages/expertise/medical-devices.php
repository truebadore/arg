...
$this->pageTitle= 'Medical Devices | ' . Yii::app()->name;
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h5 class="leadership-title">Medical Devices</h5><br />
					<p class="leadership-body">Breast Implant, Contact Lens, Nerve Repair</p><br />
				</div>
			</div>
		</div>
	</section>
